<template>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4" >
           <div class="bg-white shadow-2xl border-2 text-center">
            ...
            <svg  @click="toggleModal"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 p-2 rounded-full cursor-pointer bg-red-600 text-white">
                ...
                <p>{{ todo.id }}</p>
            <svg @click="todoStore.deleteTodos(todo.id)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 p-2 text-white bg-red-600 rounded-full">
    ...
    export default {
        ...
        setup() {
            ...
            const header = ref('Edit a new todo')
         ...
         try {
            ...
            return {todoStore, todoStore, header, showModal, toggleModal, editTodos}
        }
    }
    </script>